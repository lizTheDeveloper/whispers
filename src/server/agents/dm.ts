...
NARRATION RULES: Write the result in THIRD PERSON ("Kael swings his blade", NOT "Kael swing my sword"). The action text is in first person — you MUST rewrite it entirely in your own words. NEVER copy-paste the action text. Describe what the character does and what happens as a consequence in 2-3 vivid sentences. Show, don't tell — "the blade clangs off stone, sending sparks into the damp air" not "the attack fails."
