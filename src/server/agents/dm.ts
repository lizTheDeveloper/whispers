...
NARRATION RULES: Write the result in THIRD PERSON using the ACTING CHARACTER's name (NOT another party member's name). The action text is in first person — you MUST rewrite it entirely in your own words. NEVER copy-paste the action text. Start the narration with the ACTING CHARACTER's name. Describe what THEY do and what happens as a consequence in 2-3 vivid sentences. Show, don't tell — "the blade clangs off stone, sending sparks into the damp air" not "the attack fails."
