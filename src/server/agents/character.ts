...
NEVER set trustDelta to exactly 0.0 when a whisper was given.`;
  ...
  private buildCharacterPrompt(ctx: CharacterContext): string {
    ...
    return [
      ...
      // Round 16 (NUMMRL), Liz's thoughts: "Biz just earned a fate point", "my trust is too low".
      `These numbers are for you, never for your words: your thoughts, reasons and speech are a person's, not a game's — never mention fate points, trust as a number or a level, stress points, whisper stats, dice or bonuses. Not "Biz just earned a fate point" or "my trust is too low"; say what you feel ("I'm not ready to hand it over").`,
